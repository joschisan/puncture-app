  ...
  child: ListTile(
    ...
    leading: CircleAvatar(
      ...
      child: payment.isPending
          ...
          : Icon(getStatusIcon(payment), color: Colors.deepPurple, size: 26),
    ),
    title: payment.isIncoming
        ? Align(
...
TaskEither<String, void> navigateToReceive(
  ...
  return safeTask(() => punctureConnection.bolt12ReceiveVariableAmount()).map((
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) =>
            ReceiveScreen(offer: offer, punctureConnection: punctureConnection),
      ),
    );
  });
}
